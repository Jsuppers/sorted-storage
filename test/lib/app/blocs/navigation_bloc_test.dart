...
class MockNavigatorState extends NavigatorState {
  ...
  MockNavigatorState({this.popCallback, this.canPopCallback, this.pushNamedCallback, this.pushReplacementNamedCallback});
  @override
...
main() {
  group(
      'NavigationBloc',
        ...
        blocTest(
            'Given a NavigationBloc when it is initialized return nothing',
